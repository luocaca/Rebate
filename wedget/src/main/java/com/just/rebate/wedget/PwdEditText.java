...
public class PwdEditText extends AppCompatTextView {
    ...
    private void setAttrs(AttributeSet attrs) {
        TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.PwdEditText);
        if (t != null) {
            ...
            checkedColor = t.getColor(R.styleable.PwdEditText_checkedColor,0xffe5e5e5);
            defaultColor = t.getColor(R.styleable.PwdEditText_defaultColor,0xffcccccc);
            backColor = t.getColor(R.styleable.PwdEditText_backColor,0xffffffff);
            textColor = t.getColor(R.styleable.PwdEditText_textColor,0xFF000000);
            waitInputColor = t.getColor(R.styleable.PwdEditText_waitInputColor,0xFFe5e5e5);
