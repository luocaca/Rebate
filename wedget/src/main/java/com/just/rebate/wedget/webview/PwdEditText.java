package com.just.rebate.wedget.webview;
...
public class PwdEditText extends AppCompatTextView {
    ...
    public void initShowInput(int bgcolor, int pwdlength, float slpilinewidth, int splilinecolor, int pwdcolor, int pwdsize)
    {
        ...
        LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(dip2px(context, slpilinewidth), RelativeLayout.LayoutParams.MATCH_PARENT);
