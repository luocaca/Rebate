...
public class HistoryIntegralAdapter extends RecyclerView.Adapter<HistoryIntegralAdapter.ViewHolder> {
    ...
    public HistoryIntegralAdapter(List<IntegralDataBean.DataBean> integralDetailBean) {
        super();
    ...
    @Override
    public void onBindViewHolder(@NonNull HistoryIntegralAdapter.ViewHolder holder, int position) {
