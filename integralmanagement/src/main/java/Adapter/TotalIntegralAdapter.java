...
public class TotalIntegralAdapter extends RecyclerView.Adapter<TotalIntegralAdapter.ViewHolder> {

    private List<IntegralDataBean.DataBean> integralDetailBeans;
    private Context mContext;


    public TotalIntegralAdapter(List<IntegralDataBean.DataBean> integralDetailBean) {
        super();
    ...
    @Override
    public void onBindViewHolder(@NonNull TotalIntegralAdapter.ViewHolder holder, int position) {
