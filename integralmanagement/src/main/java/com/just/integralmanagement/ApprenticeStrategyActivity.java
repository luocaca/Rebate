...
public class ApprenticeStrategyActivity extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apprentice_stratrgy);
        getSupportActionBar().setTitle("收徒攻略");
        setToolbars();
    }
